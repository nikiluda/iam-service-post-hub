...
public class PasswordUtils {
    ...
    public static boolean isNotValidPassword(String password) {
        ...
        int characterNumber = ApiConstants.REQUIRED_MIN_CHARACTERS_NUMBER_IN_PASSWORD;
        ...
        int digitalNumber = ApiConstants.REQUIRED_MIN_DIGITS_NUMBER_IN_PASSWORD;

        for (int i = 0; i < trim.length(); i++) {

            String currentLetter =
                    String.valueOf(trim.charAt(i));
            ...
            characterNumber -= ApiConstants.PASSWORD_CHARACTERS.contains(currentLetter) ? 1 : 0;
            ...
            digitalNumber -= ApiConstants.PASSWORD_DIGITS.contains(currentLetter) ? 1 : 0;
        }

        return characterNumber > 0
                || lettersUCaseNumber > 0
                || lettersLCaseNumber > 0
                || digitalNumber > 0;
    }
}
